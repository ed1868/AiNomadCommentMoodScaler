...
# targetPersonas is an array of targets (needs to be looped)
print(os.environ["TARGETS"])
targetPersonas = os.environ["TARGETS"];
...
reddit = praw.Reddit(
    ...
    user_agent=f"script:test:0.0.1 (by u/aiNomads)",
)
...
filename, subreddits = "targets_top_3.csv", targetPersonas
